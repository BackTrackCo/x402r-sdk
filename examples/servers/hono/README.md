# @x402r/hono Merchant Server Example

Hono server demonstrating how to protect API endpoints with a refundable paywall using the `@x402/hono` middleware and x402r escrow scheme.
