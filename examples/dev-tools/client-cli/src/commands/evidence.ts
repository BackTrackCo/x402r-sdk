 ...
 */
export async function listEvidence(options: Omit<EvidenceOptions, "walletClient">): Promise<void> {
  const { paymentInfo, nonce, operatorAddress, refundRequestEvidenceAddress, publicClient } =
    options;
