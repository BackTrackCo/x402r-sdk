...
const FACTORY_ADDRESSES: FactoryAddresses = {
  ...
  hookCombinator: '0xF000000000000000000000000000000000000009',
  signatureCondition: '0xF00000000000000000000000000000000000000A',
  refundRequest: '0xF00000000000000000000000000000000000000B',
}
