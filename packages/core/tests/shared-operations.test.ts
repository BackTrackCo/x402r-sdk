...
describe('Shared Refund Operations', () => {
  ...
  describe('getRefundStatus', () => {
    it('should return the status', async () => {
      (publicClient.readContract as ReturnType<typeof vi.fn>).mockResolvedValue(RequestStatus.Approved);
  ...
  describe('getRefundRequestByKey', () => {
    it('should return refund request by composite key', async () => {
      const compositeKey = '0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890' as `0x${string}`;
      const mockData = {
        paymentInfoHash: '0x1234' as `0x${string}`,
        nonce: 0n,
