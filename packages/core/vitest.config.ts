  ...
  test: {
    coverage: {
      ...
      exclude: [
        ...
        'src/actions/operator/capture.ts',
        ...
        'src/actions/refund-budget/approveRefundAllowance.ts',
        'src/actions/refund-budget/voidPayment.ts',
        'src/actions/refund-budget/refund.ts',
        // Pure readContract passthroughs — no mapping, direct return
        'src/actions/freeze/isFrozen.ts',
        'src/actions/refund-budget/getRefundAllowance.ts',
