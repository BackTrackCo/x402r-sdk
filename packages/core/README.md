...
| `@x402r/core/payment` | `computePaymentInfoHash()`, `toPaymentInfo()`, `validatePaymentInfo()`, `signReceiveAuthorization()` (ERC-3009), `signPermit2Authorization()` + `createPermit2ApprovalTx()` + `getPermit2AllowanceReadParams()` (Permit2) |
